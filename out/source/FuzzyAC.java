...
public class FuzzyAC extends PApplet {
...
private void drawThermometer(){
    ...
    text("0",80,305);
    line(95, (int)(300-18.75f), 100, (int)(300-18.75f)); // 5 tick
    line(90, (int)(300-37.5f), 100, (int)(300-37.5f)); // 10 tick
    text("10",73,(int)(300-37.5f+5));
    line(95,(int)(300-56.25f), 100, (int)(300-56.25f)); // 15 tick
    
    line(90, 300-75, 100, 300-75); // 20 tick
    line(95, (int)(300-93.75f), 100, (int)(300-93.75f)); // 25 tick
    text("20",73,(int)(300-75+5));
    line(90, (int)(300-112.5f), 100, (int)(300-112.5f)); // 30 tick
    line(95, (int)(300-131.25f), 100, (int)(300-131.25f)); // 35 tick
    text("30",73,(int)(300-112.5f+5));
...
public void createFuzzyEngine(){
        ...
        inputVariable1.setRange(0.00f, 40.00f);
        ...
        inputVariable2.setRange(0.00f, 40.00f);
        ...
        outputVariable.addTerm(new Trapezoid("cool", -10.0f, -7.5f, -5, -0));
        outputVariable.addTerm(new Triangle("maintain", -1, 0, 1));
        outputVariable.addTerm(new Trapezoid("heat",  0, 5, 7.5f, 10));    
        outputVariable.setRange(-10.00f, 10.00f);
...
public void draw() {
  ...
  public void settings() { size(800, 360); }

  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "FuzzyAC" };
    if (passedArgs != null) {
